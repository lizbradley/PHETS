...
.. function:: make_movie(filtration, out_filename[, color_scheme='none', camera_angle=(135, 55), alpha=1, dpi=150, save_frames=False, framerate=1])
   ...
   :param str out_filename: Movie path and filename. Should end in ".mp4" or other video format.
...
.. function:: compare_multi(*args, **kwargs)
...
.. function:: plot_dists_vs_ref(*args, **kwargs)
...
.. function:: plot_dists_vs_mean(*args, **kwargs)
...
.. functions:: plot_clusters(*args, **kwargs)

   See plot_dists_vs_mean for parameters.



.. functions:: plot_variances(*args, **kwargs)
