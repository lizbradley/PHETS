...
piano_traj = embed(
	piano_sig, tau=.01192, m=2,
	time_units='seconds', crop=(1.72132, 1.77872),
	normalize_crop=True,
...
paper_path = '/home/elliott/programming/phets_notes/IDA 2017/figs/experiment_normalized/'
ticks = [-1, -.33, .33, 1]
ticks = None
...
if test == 30:
	...
	plt.savefig(paper_path + 'fig3_w_cliques.png')
...
if test == 40:
	...
	plot_filtration_pub(filtration, 6, ax1)							# 4a
	...
	filtration = Filtration(traj, filt_params)
	plot_filtration_pub(filtration, 6, ax2)							# 4b
