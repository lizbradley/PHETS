...
from signals.plots import ts_full_fig
...
ts_full_fig('../../paper/sigs/fig_6/upright_sig.png', upright_sig, title='upright piano')

grand_sig = BaseTrajectory(
	'../../datasets/time_series/piano_revisit/C134C/a440/07- C134C-consolidated.txt')


ts_full_fig('../../paper/sigs/fig_6/grand_sig.png', grand_sig, title='grand piano')
