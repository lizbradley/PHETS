...
euc_filt = Filtration(ellipse_traj, euc_params)
...
ham5_filt = Filtration(ellipse_traj, ham5_params)
...
doamp5_filt = Filtration(ellipse_traj, doamp5_params)
...
m2d10_filt = Filtration(ellipse_traj, m2d10_params)
...
dcov20_filt = Filtration(ellipse_traj, dcov20_params)
...
dcovn20_filt = Filtration(ellipse_traj, dcovn20_params)
...
gi_filt = Filtration(ellipse_traj, gi_params)
...
hamn10_filt = Filtration(ellipse_traj, hamn10_params)
...
hamn1_filt = Filtration(ellipse_traj, hamn1_params)
...
ham1_filt = Filtration(ellipse_traj, ham1_params)
